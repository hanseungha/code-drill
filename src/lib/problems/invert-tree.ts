...
export const invertTree: Problem = {
  ...
  difficulty: "medium",
  tags: ["트리", "DFS", "재귀"],
  summary: "모든 노드의 왼쪽과 오른쪽 자식을 맞바꿔 좌우 대칭으로 만듭니다.",
  description: [
    "이진 트리의 루트 `root`가 주어집니다. 모든 노드에서 왼쪽 자식과 오른쪽 자식을 맞바꾼 트리의 루트를 반환하세요.",
    "루트에서 한 번만 바꾸는 것이 아니라 **모든 깊이에서** 바꿔야 합니다.",
    TREE_ENCODING_NOTE,
    "반환값도 트리입니다. 채점기가 다시 레벨 순서 배열로 바꿔서 비교하므로, 노드를 그대로 반환하면 됩니다.",
  ],
  examples: [
    {
      input: "root = [4, 2, 7, 1, 3, 6, 9]",
      output: "[4, 7, 2, 9, 6, 3, 1]",
      explain: "모든 층에서 좌우가 뒤집혔습니다.",
    },
 ...
 * 새 노드가 필요하면 new TreeNode(val, left, right) 로 만들 수 있습니다.
 *
...
# 새 노드가 필요하면 TreeNode(val, left, right) 로 만들 수 있습니다.
...
`,
  ...
  hint: "각 노드에서 두 자식을 맞바꾸고, 그 두 자식에 대해 같은 일을 재귀로 시키면 끝입니다. 빈 노드는 그대로 돌려보내세요.",
  solution: {
