...
export const maxSubarray: Problem = {
  ...
  difficulty: "medium",
  tags: ["DP", "배열"],
  summary: "연속한 부분 수열 중 합이 가장 큰 값을 구해요.",
  description: [
    "정수 배열 `nums`가 주어져요. 길이가 1 이상인 연속한 부분 수열 중 원소의 합이 가장 큰 값을 반환해요.",
  ...
  examples: [
    {
      ...
      output: "6",
      explain: "부분 수열 [4, -1, 2, 1]의 합이 6으로 가장 커요.",
    },
...
`,
  ...
  hint: "각 위치에서 '여기서 끝나는 최대 합'은 max(현재 값, 이전까지의 최대 합 + 현재 값) 이에요. 이 값을 훑으면서 전체 최댓값을 갱신해요 (카데인 알고리즘).",
  solution: {
