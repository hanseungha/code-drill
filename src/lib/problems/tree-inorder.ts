...
export const treeInorder: Problem = {
  ...
  difficulty: "easy",
  tags: ["트리", "DFS", "재귀"],
  summary: "이진 트리를 왼쪽 → 자기 자신 → 오른쪽 순서로 방문해요.",
  description: [
    "이진 트리의 루트 `root`가 주어져요. 중위 순회(inorder) 순서로 방문한 노드 값을 배열로 반환해요.",
    "중위 순회는 각 노드에서 **왼쪽 서브트리 → 자기 자신 → 오른쪽 서브트리** 순으로 내려가요. 이 순서가 중요한 이유는 이진 탐색 트리를 중위 순회하면 값이 정렬된 채로 나오기 때문이에요.",
    TREE_ENCODING_NOTE,
  ],
  examples: [
    {
      ...
      output: "[1, 3, 2]",
      explain:
        "1의 왼쪽은 비었으니 1을 먼저 방문하고, 오른쪽 서브트리(2)로 가서 그 왼쪽 자식 3을 먼저 방문해요.",
    },
    {
      input: "root = [4, 2, 6, 1, 3, 5, 7]",
      output: "[1, 2, 3, 4, 5, 6, 7]",
      explain: "이진 탐색 트리라 정렬된 순서로 나와요.",
    },
    { input: "root = []", output: "[]" },
  ],
  constraints: [
...
`,
  ...
  hint: "결과 배열 하나를 만들어두고, 재귀 함수 안에서 왼쪽을 먼저 처리하고 자기 값을 넣은 다음 오른쪽을 처리해요. 세 줄의 순서가 곧 순회 이름이에요.",
  solution: {
