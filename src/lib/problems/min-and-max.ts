...
export const minAndMax: Problem = {
  ...
  difficulty: "easy",
  tags: ["배열", "구현"],
  summary: "한 번의 순회로 두 값을 함께 구해 배열로 반환합니다.",
  description: [
    "정수 배열 `nums`가 주어집니다. 가장 작은 값과 가장 큰 값을 `[최솟값, 최댓값]` 배열로 반환하세요.",
    "배열을 두 번 훑어도 답은 같지만, **한 번만 훑으면서 두 값을 동시에 갱신**해 보세요. 순회 한 번에 여러 정보를 모으는 습관은 이후 거의 모든 주차에서 다시 쓰입니다.",
    "값을 여러 개 돌려주는 방법도 함께 익힙니다. 자바스크립트는 배열로, 파이썬은 튜플이나 리스트로 반환하면 됩니다.",
  ],
  examples: [
    { input: "nums = [3, 1, 4, 1, 5]", output: "[1, 5]" },
    { input: "nums = [-2]", output: "[-2, -2]", explain: "원소가 하나면 최솟값과 최댓값이 같습니다." },
...
`,
  ...
  hint: "첫 원소로 두 변수를 초기화하고 두 번째 원소부터 비교하세요. `0`으로 초기화하면 모든 값이 음수인 배열에서 최댓값이 `0`으로 남습니다.",
  solution: {
