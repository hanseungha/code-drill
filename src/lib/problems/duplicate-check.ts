...
export const duplicateCheck: Problem = {
  ...
  difficulty: "easy",
  tags: ["해시", "배열"],
  summary: "앞에서부터 훑으며 처음으로 다시 나온 값을 찾습니다.",
  description: [
    "정수 배열 `nums`가 주어집니다. 앞에서부터 훑을 때 **처음으로 다시 나온 값**을 반환하세요.",
    "다시 나온 값이 하나도 없으면 `-1`을 반환합니다. 배열에 `-1`이 들어 있을 수도 있지만, 그 경우에도 `-1`이 두 번 나왔다면 답은 `-1`입니다.",
  ],
  examples: [
    {
      input: "nums = [1, 2, 3, 4, 2, 5]",
      output: "2",
      explain: "4까지는 모두 처음 보는 값이고, 다섯 번째 원소 2에서 처음으로 이미 본 값을 만납니다.",
    },
    { input: "nums = [1, 2, 3]", output: "-1", explain: "중복이 없습니다." },
...
`,
  ...
  hint: "이미 본 값을 셋에 넣어두면 '본 적 있나?'를 평균 O(1)에 물어볼 수 있습니다. 배열을 두 번 도는 O(n²) 대신 한 번만 돌면 됩니다.",
  solution: {
