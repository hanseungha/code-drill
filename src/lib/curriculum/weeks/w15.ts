...
export const w15: Week = {
  ...
  concept: [
    ...
    {
      kind: "text",
      body: "미로에서 길을 찾는 두 가지 성격이라고 생각하면 쉬워요. **DFS는 한 방향으로 끝까지 가 보는 사람**이에요. 막히면 갈림길로 되돌아와 다음 길을 시도해요(재귀·스택). **BFS는 연못에 던진 물결**이에요. 시작점에서 한 칸, 두 칸, 세 칸씩 동심원으로 퍼져요(큐). 둘 다 모든 정점을 빠짐없이 훑고, 차이는 **다음에 어디를 볼 것인가**뿐이에요.",
    },
    {
      kind: "list",
      items: [
    ...
    {
      kind: "text",
      body: "같은 그래프를 두 방식으로 훑으면 **방문 순서가 어떻게 갈리는지** 직접 따라가 볼게요. 이웃은 번호가 작은 쪽부터 본다고 할게요.",
    },
    {
      kind: "trace",
      caption: "정점 0에서 출발 — BFS는 층층이, DFS는 깊이",
      lines: [
        "그래프 (양방향)          이웃 목록",
        "      0                 0 : 1, 2",
        "     / \\                1 : 0, 3",
        ...
        "  방문 순서 → 0 1 2 3 4",
        "",
        "DFS(0) — 갈 수 있는 데까지 파고들기",
        "  0 → 1 → 3 → 4 → 2     (4에서 막히자 2로)",
        "  방문 순서 → 0 1 3 4 2",
      ],
    },
    {
