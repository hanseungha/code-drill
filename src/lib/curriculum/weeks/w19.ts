...
export const w19: Week = {
  ...
  concept: [
    {
      kind: "text",
      body: "9주차에 그리디가 지는 걸 봤습니다. 후회 없는 선택을 하려면 모든 경우를 따져야 하는데, 그냥 따지면 지수 시간입니다. 동적 계획법(DP)은 **이미 계산한 하위 문제를 다시 계산하지 않음**으로써 그것을 다항 시간으로 만듭니다.",
    },
    {
      kind: "text",
      body: "DP를 쓸 수 있는 조건은 13주차 재귀에서 이미 봤습니다. 중복되는 하위 문제가 있고(피보나치), 하위 문제의 최적해로 전체 최적해를 만들 수 있으면 됩니다.",
    },
    {
      kind: "heading",
      body: "점화식 세우는 4단계",
