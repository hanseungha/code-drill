...
/**
 * code-drill theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { codeDrillTheme } from './code-drill';
 *   import './code-drill.css';
 */
export const codeDrillTheme = {
  name: 'code-drill',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-geist-sans), system-ui, -apple-system, sans-serif",
    "--font-family-heading": "var(--font-geist-sans), system-ui, -apple-system, sans-serif",
    "--font-family-code": "var(--font-geist-mono), ui-monospace, \"SF Mono\", Monaco, monospace",
